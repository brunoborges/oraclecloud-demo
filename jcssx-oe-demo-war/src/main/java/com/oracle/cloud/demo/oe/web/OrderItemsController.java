...
@ManagedBean(name = "orderItemsController")
@SessionScoped
public class OrderItemsController implements Serializable {
    ...
    @EJB
    private OrderItemsFacade ejbFacade;
    ...
    public OrderItem getOrderItems(Long id) {
    ...
    public static class OrderItemsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getOrderItems(getKey(value).getLineItemId());
        }

        OrderItem getKey(String value) {
            OrderItem key;
            key = new OrderItem();
            key.setLineItemId(Long.parseLong(value));
            return key;
        }

        String getStringKey(OrderItem value) {
