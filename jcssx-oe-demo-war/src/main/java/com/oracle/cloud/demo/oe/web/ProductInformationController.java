...
public class ProductInformationController implements Serializable {
    ...
    @EJB
    private ProductInformationFacade ejbFacade;
    ...
    public static class ProductInformationControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            ProductInformationController controller = (ProductInformationController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ProductInformation) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ProductInformation.class.getName());
            }
        }
    ...
    public void removerItemTabela() {
        int itemIndex = Integer.valueOf(FacesContext
                .getCurrentInstance()
                .getExternalContext()
                .getRequestParameterMap()
                .get("itemIndex")
                .toString());
        BasketItem item = tabelaProdutos.get(itemIndex);
    ...
    public DataModel<BasketItem> getTabelaProdutos() {
        return new ArrayDataModel<>(tabelaProdutos.toArray(new BasketItem[0]));
    }
    ...
    public void setProdutosDisponiveis(Set<ProductInformation> produtosDisponiveis) {
